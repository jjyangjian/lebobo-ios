...
@interface SWReturnOrderDetailsVC ()<UITextViewDelegate>
@property (nonatomic,strong) UIScrollView *backScrollView;
@property (nonatomic,strong) NSMutableArray *goodsArray;
@end

@implementation SWReturnOrderDetailsVC
...
- (void)creatUI{
    ...
    for (int i = 0; i < _goodsArray.count; i ++) {
        ...
        SWCartModel *model = _goodsArray[i];
    ...
    UIView *SWAddressView = [[UIView alloc]initWithFrame:CGRectMake(0, SWPayView.bottom + 10, _window_width, 130)];
    ...
    adsleftL.text = @"收货人:\n\n联系电话:\n\n收货地址:";
    [SWAddressView addSubview:adsleftL];
    [adsleftL mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.top.equalTo(SWAddressView).offset(15);
