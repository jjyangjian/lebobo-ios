...
@implementation SWPayTypeSelectView{
    UIView *showView;
}
...
- (void)creatUI{
    ...
    showView.layer.mask = [[SWToolClass sharedInstance] setViewLeftTop:10 andRightTop:10 andView:showView];
    [[SWToolClass sharedInstance] lineViewWithFrame:CGRectMake(15, 49, _window_width-30, 1) andColor:RGB_COLOR(@"#f5f5f5", 1) andView:showView];
    ...
    NSArray *array2 = @[@"微信快捷支付",[NSString stringWithFormat:@"可用余额：¥%@",[SWConfig getcoin]]];
