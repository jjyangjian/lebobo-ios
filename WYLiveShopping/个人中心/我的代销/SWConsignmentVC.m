...
- (void)requestData{
    [SWToolClass getQCloudWithUrl:@"mybring" Suc:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        if (code == 200) {
            _infoDic = info;
