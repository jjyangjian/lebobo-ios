...
@implementation SWMineBalanceVC
...
//        btn.showTitleLabel.textColor = RGB_COLOR(@"#999999", 1);
        ...
        btn = [SWToolClass setUpImgDownText:btn space:14];
    }
...
-(SWRecommendView *)recommendV{
    if (!_recommendV) {
        _recommendV = [[SWRecommendView alloc]initWithFrame:CGRectMake(0, (_window_width-30) * 0.48 + 112, _window_width, _backScrollView.height) andNothingImage:nil];
    }
    return _recommendV;
}
- (void)buttonClick:(UIButton *)sender{
    SWBilldetailsVC *vc = [[SWBilldetailsVC alloc]init];
