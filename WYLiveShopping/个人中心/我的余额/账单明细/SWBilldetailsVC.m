...
@interface SWBilldetailsVC ()<TYTabPagerBarDataSource,TYTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate>
//page
...
@implementation SWBilldetailsVC
- (void)addtabbar{
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    SWBillListVC *VC = [[SWBillListVC alloc]init];
