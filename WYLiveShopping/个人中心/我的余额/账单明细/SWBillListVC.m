...
#import "SWBillListVC.h"
#import "SWCommissionCell.h"
@interface SWBillListVC ()
...
//    0 全部  1 消费  2 充值  3 返佣  4 提现
    [SWToolClass getQCloudWithUrl:[NSString stringWithFormat:@"spread/commission/%@?page=%d&limit=20",_type,page] Suc:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
