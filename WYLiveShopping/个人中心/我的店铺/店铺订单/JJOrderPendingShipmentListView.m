...
@interface JJOrderPendingShipmentListView () <UITableViewDelegate, UITableViewDataSource> {
...
- (void)requestData {
    NSString *url = [NSString stringWithFormat:@"order/list?type=1&status=%@&page=%d", self.statusType, page];
