...
- (void)pagerTabBar:(TYTabPagerBar *)pagerTabBar didSelectItemAtIndex:(NSInteger)index {
    ...
    _curSelIndex = index;
    id obj = controlArray[_curSelIndex];
    if ([obj isKindOfClass:[AdminGoodsViewController class]] ) {
        AdminGoodsViewController *vc = (AdminGoodsViewController *)obj;
