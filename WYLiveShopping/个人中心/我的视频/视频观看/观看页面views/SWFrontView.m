...
//        _musicL = [[SWRKLampView alloc]initWithFrame:CGRectMake(22, _botView.height-20, _botView.width/2, 20)];
...
//        [_botView addSubview:_musicL];
        ...
        [_shopButton setTitle:@"查看同款商品" forState:0];
