...
-(void)buildLayout
{
    ...
    backLayer.strokeColor  = RGB_COLOR(@"#f93232", 1).CGColor;
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[RGB_COLOR(@"#2889f7", 1) CGColor],(id)[RGB_COLOR(@"#2889f7", 1) CGColor], nil]];//normalColors
