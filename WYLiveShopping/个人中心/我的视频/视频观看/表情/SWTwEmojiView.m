...
#import "SWEmojiCell.h"
@interface SWCollCellWhite : UICollectionViewCell

@end

@implementation SWCollCellWhite
...
- (void)creatUI{
    SWLWLCollectionViewHorizontalLayout *layout =[[SWLWLCollectionViewHorizontalLayout alloc]init];
    ...
    [collectionView registerClass:[SWCollCellWhite class] forCellWithReuseIdentifier:@"emojiWhite"];
    [collectionView registerNib:[UINib nibWithNibName:@"SWEmojiCell" bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"emojiCELL"];
    ...
    [_sendEmojiBtn setTitle:@"发送" forState:0];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    if (indexPath.item >= emojiArray.count) {
        ...
        SWEmojiCell *cell = (SWEmojiCell *)[collectionView dequeueReusableCellWithReuseIdentifier:identifierCell
                                                                               forIndexPath:indexPath];
