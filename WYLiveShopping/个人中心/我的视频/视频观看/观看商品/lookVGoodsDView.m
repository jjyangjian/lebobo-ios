...
//    [WYToolClass postNetworkWithUrl:@"Shop.GetShopInfo" andParameter:@{@"touid":minstr(_videoUserid)} success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
...
//        [WYToolClass openWXMiniProgram:minstr([goodsDic valueForKey:@"href"])];
//    }else{
