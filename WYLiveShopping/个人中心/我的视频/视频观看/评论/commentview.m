...
-(void)reloaddata:(NSString *)from{
    ...
    WeakSelf;
    [WYToolClass getQCloudWithUrl:[NSString stringWithFormat:@"videocomment&vid=%@&cid=0&lastid=%@",_videoid,lastid] Suc:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        if (code == 200) {
            //隐藏评论加载中
