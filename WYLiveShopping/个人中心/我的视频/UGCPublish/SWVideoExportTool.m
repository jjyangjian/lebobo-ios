...
@implementation SWVideoExportTool
/// 转码 MOV--MP4
 ...
 andMovEncodeToMpegToolResultBlock:(WYVideoExportToolResultBlock)resultBlock {
    ...
    [manager requestAVAssetForVideo:resourceAsset
        ...
        if ([asset isKindOfClass:[AVURLAsset class]]) {
            ...
            [SWVideoExportTool convertMovToMp4FromAVURLAsset:urlAsset
                                 andAVAssetExportPresetQuality:exportQuality
                             andMovEncodeToMpegToolResultBlock:resultBlock];
        }else{
...
+ (void)convertMovToMp4FromAVURLAsset:(AVURLAsset*)urlAsset
        andAVAssetExportPresetQuality:(ExportPresetQuality)exportQuality
    andMovEncodeToMpegToolResultBlock:(WYVideoExportToolResultBlock)movEncodeToMpegToolResultBlock {
        ...
        [exportSession exportAsynchronouslyWithCompletionHandler:^(void) {
            switch (exportSession.status) {
                ...
                case AVAssetExportSessionStatusCompleted: {
                    ...
                    movEncodeToMpegToolResultBlock(resultPath, mp4Data , nil);
                }
                    break;
