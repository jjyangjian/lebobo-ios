...
#import "SWMineCourseVC.h"
#import "SWLiveCourseCell.h"
#import "SWCourseDetaileVC.h"
#import "SWLiveCourseBuyHistoryVC.h"
@interface SWMineCourseVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SWMineCourseVC
-(void)rightBtnClick{
    SWLiveCourseBuyHistoryVC *vc = [[SWLiveCourseBuyHistoryVC alloc]init];
...
- (void)requeestData{
    [SWToolClass getQCloudWithUrl:[NSString stringWithFormat:@"mycourse&page=%ld",(long)self.page] Suc:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        [self.classTableView.mj_header endRefreshing];
        [self.classTableView.mj_footer endRefreshing];
