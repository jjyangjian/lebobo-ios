...
- (void)setModel:(SWAddressModel *)model{
    _model = model;
    ...
    _nameLabel.text = [NSString stringWithFormat:@"收货人：%@   %@",_model.name,_model.mobile];
    _detailsLabel.text = [NSString stringWithFormat:@"收货地址：%@%@%@%@",_model.province,_model.city,_model.area,_model.detail];
}
