...
NSString * const WY_TXIMSign = @"WY_TXIMSign";
NSString * const WY_brokerage_price = @"brokerage_price";
...
+ (void)saveProfile:(SWLiveUser *)user
{
    ...
    [userDefaults setObject:user.brokerage_price forKey:WY_brokerage_price];
...
+ (void)updateProfile:(SWLiveUser *)user
{
    ...
    if(user.brokerage_price!=nil) [userDefaults setObject:user.brokerage_price forKey:WY_brokerage_price];
    [userDefaults synchronize];
}
...
+ (void)clearProfile
{
    ...
    [userDefaults setObject:nil forKey:WY_brokerage_price];
    [userDefaults synchronize];
}
...
+(void)saveOwnUserTXIMSign:(NSString *)sign{
    NSUserDefaults *userDefults = [NSUserDefaults standardUserDefaults];
    [userDefults setObject:sign forKey:WY_TXIMSign];
    [userDefults synchronize];
}
+(NSString *)getOwnUserTXIMSign{
    NSUserDefaults *userDefults = [NSUserDefaults standardUserDefaults];
    NSString *value = minstr([userDefults objectForKey:WY_TXIMSign]);
    return value;
}
...
+(NSString *)brokerage_price{
    return [[NSUserDefaults standardUserDefaults] objectForKey:WY_brokerage_price];
}
