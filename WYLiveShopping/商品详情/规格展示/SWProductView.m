...
- (void)creatUI{
    ...
    if (productAttr.count > 0) {
        ...
        for (int i = 0; i < productAttr.count; i ++) {
            ...
            for (int j = 0; j < array.count; j ++) {
                ...
                CGFloat btnWidth = [[SWToolClass sharedInstance] widthOfString:minstr(array[j]) andFont:SYS_Font(12) andHeight:28] + 30;
                ...
                [btn setBackgroundImage:[SWToolClass getImgWithColor:[UIColor whiteColor]] forState:0];
                [btn setBackgroundImage:[SWToolClass getImgWithColor:normalColors] forState:UIControlStateSelected];
    ...
    whiteView.layer.mask = [[SWToolClass sharedInstance] setViewLeftTop:10 andRightTop:10 andView:whiteView];
