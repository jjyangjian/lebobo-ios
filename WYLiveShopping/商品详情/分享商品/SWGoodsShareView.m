...
@implementation SWGoodsShareView{
...
- (void)requestData{
    [SWToolClass getQCloudWithUrl:[NSString stringWithFormat:@"product/code/%@?user_type=routine",minstr([shareDic valueForKey:@"id"])] Suc:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        if (code == 200) {
