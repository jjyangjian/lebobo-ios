...
#define DEFAULTHEADVIEWCOLOR [UIColor colorWithRed:247/255.f green:249/255.f blue:252/255.f alpha:1]

@interface SWXDMultTableView()

@property (nonatomic, strong, readwrite) NSMutableArray *multopenSectionArray;

@end

@implementation SWXDMultTableView
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (view) {
        ...
        view.frame = frame;
        CGFloat labelW = width-height-10;
        CGFloat labelH = 20;
