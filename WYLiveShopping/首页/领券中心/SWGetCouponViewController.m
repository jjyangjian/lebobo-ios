...
#import "SWGetCouponViewController.h"
#import "WYCouponTableViewCell.h"

@interface SWGetCouponViewController ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation SWGetCouponViewController
