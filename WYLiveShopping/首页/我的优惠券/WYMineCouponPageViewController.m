//
//  WYMineCouponPageViewController.m
//  WYLiveShopping
//
...
@interface WYMineCouponPageViewController ()<TYTabPagerBarDataSource,TYTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate>
...
@implementation WYMineCouponPageViewController
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    WYCouponListViewController *VC = [[WYCouponListViewController alloc]init];
    if (index == 0) {
        VC.types = @"1";
    }else{
        VC.types = @"3";
