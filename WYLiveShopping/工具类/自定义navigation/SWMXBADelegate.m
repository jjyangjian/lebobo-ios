...
//
#import "SWMXBADelegate.h"
#import "SWTCNavigationController.h"
@implementation SWMXBADelegate
...
- (void)presentViewController:(UIViewController *)vc animated:(BOOL)animated completion:(void (^)())completion
{
    ...
    {
        SWTCNavigationController *nav = [[SWTCNavigationController alloc] initWithRootViewController:vc];
...
{
    if (vc.navigationController != [SWMXBADelegate sharedAppDelegate].navigationViewController)
    {
