//
//  SWZFModalTransitionAnimator.m
//
//  Created by Amornchai Kanokpullwad on 5/10/14.
//  Copyright (c) 2014 zoonref. All rights reserved.
//

#import "SWZFModalTransitionAnimator.h"

@interface SWZFModalTransitionAnimator ()
@property (nonatomic, weak) UIViewController *modalController;
@property (nonatomic, strong) SWZFDetectScrollViewEndGestureRecognizer *gesture;
...
@implementation SWZFModalTransitionAnimator
...
- (void)setDragable:(BOOL)dragable
{
    ...
    if (_dragable) {
        ...
        self.gesture = [[SWZFDetectScrollViewEndGestureRecognizer alloc] initWithTarget:self action:@selector(handlePan:)];
...
@interface SWZFDetectScrollViewEndGestureRecognizer ()
@property (nonatomic, strong) NSNumber *isFail;
@end

@implementation SWZFDetectScrollViewEndGestureRecognizer
