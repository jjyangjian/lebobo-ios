...
@interface classGoodsViewController ()<UITextFieldDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,WSLWaterFlowLayoutDelegate>{
...
@property (nonatomic,strong) WSLWaterFlowLayout *waterLayout;
...
- (void)changeListShow{
    ...
    if (changeBtn.selected) {
        _goodsCollectionView.collectionViewLayout = _normalLayout;
    }else{
        _goodsCollectionView.collectionViewLayout = _waterLayout;
    }
...
-(UICollectionView *)goodsCollectionView{
    if (!_goodsCollectionView) {
        ...
        _waterLayout = [[WSLWaterFlowLayout alloc] init];
