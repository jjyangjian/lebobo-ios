...
- (void)getRowHeight{
    CGFloat wordHeight = [[SWToolClass sharedInstance] heightOfString:[NSString stringWithFormat:@"占位符%@",_content] andFont:SYS_Font(13) andWidth:_window_width-50];
    _rowH += wordHeight;
    if (_isLive) {
