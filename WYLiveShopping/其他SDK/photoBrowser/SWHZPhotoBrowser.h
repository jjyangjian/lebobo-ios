...
@class HZButton, SWHZPhotoBrowser;

//配置小图和大图
@protocol HZPhotoBrowserDelegate <NSObject>
@required
- (UIImage *)photoBrowser:(SWHZPhotoBrowser *)browser placeholderImageForIndex:(NSInteger)index;
- (NSURL *)photoBrowser:(SWHZPhotoBrowser *)browser highQualityImageURLForIndex:(NSInteger)index;
@end


@interface SWHZPhotoBrowser : UIView <UIScrollViewDelegate>
