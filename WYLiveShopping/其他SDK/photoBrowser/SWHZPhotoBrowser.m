...
#import "SWHZPhotoBrowserView.h"
#import "HZPhotoBrowserConfig.h"
#import <AssetsLibrary/AssetsLibrary.h>
#import <MobileCoreServices/MobileCoreServices.h>

@interface SWHZPhotoBrowser()
...
@property (nonatomic,strong) SWHZPhotoBrowserView *photoBrowserView;
@property (nonatomic,assign) UIDeviceOrientation orientation;
@property (nonatomic,assign) HZPhotoBrowserStyle photoBrowserStyle;
@end
@implementation SWHZPhotoBrowser 
{
...
//    NSLog(@"layoutSubviews -- ");
    ...
    [_scrollView.subviews enumerateObjectsUsingBlock:^(SWHZPhotoBrowserView *obj, NSUInteger idx, BOOL *stop) {
...
- (UIImageView *)tempView{
    if (!_tempView) {
        SWHZPhotoBrowserView *photoBrowserView = _scrollView.subviews[self.currentImageIndex];
...
- (void)setPhotoBrowserView:(SWHZPhotoBrowserView *)photoBrowserView{
...
- (void)saveImage
{
    ...
    SWHZPhotoBrowserView *currentView = _scrollView.subviews[index];
...
- (void)setupScrollView
{
    ...
    for (int i = 0; i < self.imageCount; i++) {
        SWHZPhotoBrowserView *view = [[SWHZPhotoBrowserView alloc] init];
...
{
    SWHZPhotoBrowserView *view = _scrollView.subviews[index];
...
-(void)onDeviceOrientationChange
{
    ...
    SWHZPhotoBrowserView *currentView = _scrollView.subviews[self.currentImageIndex];
    UIDeviceOrientation orientation = [UIDevice currentDevice].orientation;
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    for (SWHZPhotoBrowserView *view in _scrollView.subviews) {
...
{
    SWHZPhotoBrowserView *view = _scrollView.subviews[self.currentImageIndex];
