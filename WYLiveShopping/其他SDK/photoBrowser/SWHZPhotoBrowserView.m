...
#import "SWHZWaitingView.h"

@interface SWHZPhotoBrowserView() <UIScrollViewDelegate>
@property (nonatomic,strong) SWHZWaitingView *waitingView;
@property (nonatomic, strong) NSURL *imageUrl;
@property (nonatomic, strong) UIImage *placeHolderImage;
@property (nonatomic, strong) UIButton *reloadButton;
@end

@implementation SWHZPhotoBrowserView
//- (void)dealloc{
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    //添加进度指示器
    SWHZWaitingView *waitingView = [[SWHZWaitingView alloc] init];
