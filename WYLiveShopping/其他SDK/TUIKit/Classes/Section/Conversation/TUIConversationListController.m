...
//    _searchBar.frame = CGRectMake(0, 0, self.view.bounds.size.width, 44);
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.naviView.bottom, _window_width, _window_height-self.naviView.bottom-ShowDiff)];
...
- (void)didSelectConversation:(TUIConversationCell *)cell
{
    ...
    [chat setConversationData:cell.convData];
    chat.block = ^{
        dispatch_async(dispatch_get_main_queue(), ^{
            cell.convData.unreadCount = 0;
