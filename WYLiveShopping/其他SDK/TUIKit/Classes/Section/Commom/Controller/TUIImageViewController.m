...
//    self.navigationController.navigationBar.shadowImage = [UIImage new];
    self.contentView = [[UIView alloc]initWithFrame:CGRectMake(0, self.naviView.bottom, _window_width, _window_height-self.naviView.height)];
    ...
    if (isExist) {
        ...
        _progress = [[UILabel alloc] initWithFrame:CGRectMake(0, self.naviView.bottom, _window_width, _window_height-self.naviView.height)];
        _progress.textColor = [UIColor whiteColor];
        _progress.font = [UIFont systemFontOfSize:18];
        _progress.textAlignment = NSTextAlignmentCenter;
        [self.contentView addSubview:_progress];

        _button = [[UIButton alloc] initWithFrame:CGRectMake((self.contentView.frame.size.width - 80) * 0.5, self.contentView.frame.size.height - 60, 80, 30)];
