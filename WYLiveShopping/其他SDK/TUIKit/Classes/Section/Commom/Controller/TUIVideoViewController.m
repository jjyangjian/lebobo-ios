...
//    self.navigationController.navigationBar.shadowImage = [UIImage new];
    ...
    {
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.naviView.bottom, _window_width, _window_height-self.naviView.height)];
...
- (void)addPlayer:(NSString *)path
{
    ...
    [vc.player play];
    vc.view.frame = CGRectMake(0, self.naviView.bottom, _window_width, _window_height-self.naviView.height);
