...
#define TUIKitFace(name) [[NSBundle mainBundle] pathForResource:@"YBFaceEmoji" ofType:@"bundle"] == nil ? ([[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent: @"其他SDK/TUIKit/YBFaceEmoji.bundle"] stringByAppendingPathComponent:name]) : ([[[NSBundle mainBundle] pathForResource:@"YBFaceEmoji" ofType:@"bundle"] stringByAppendingPathComponent:name])
