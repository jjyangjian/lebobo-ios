...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.titleL.text = _conversationData.title;
    [self setupViews];
}
...
- (void)setupViews
{
    ...
    _messageController.view.frame = CGRectMake(0, self.naviView.bottom, self.view.frame.size.width, self.view.frame.size.height - TTextView_Height - Bottom_SafeHeight-self.naviView.bottom);
...
- (void)inputController:(TUIInputController *)inputController didChangeHeight:(CGFloat)height
{
    ...
    [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        ...
        msgFrame.size.height = ws.view.frame.size.height - height-self.naviView.height;
