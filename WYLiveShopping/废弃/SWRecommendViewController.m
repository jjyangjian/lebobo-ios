...
@interface SWRecommendViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
...
- (void)requestData{
    [SWToolClass getQCloudWithUrl:[NSString stringWithFormat:@"featured?page=%d",page] Suc:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
