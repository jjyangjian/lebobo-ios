...
@interface SWTabBarController ()<UITabBarDelegate,UITabBarControllerDelegate>//ZYTabBarDelegate
{
...
//    //设置子视图
    ...
    [JJAppConfigManager configHomeConfigWithCompletion:^{
        if ([SWCommon tx_sdkappid]) {
            [JJAppConfigManager configTXIM];
            if ([SWConfig getOwnUserTXIMSign]) {
...
//        SWZYTabBar *tabBar = [SWZYTabBar appearance];
