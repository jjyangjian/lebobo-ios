...
#define ZYMagin 30
@interface SWZYTabBar ()<MXtabbarDelegate>
@end
@implementation SWZYTabBar
//对按钮的一些基本设置
- (void)setUpPathButton:(SWMXtabbar *)pathButton {
...
- (void)drawRect:(CGRect)rect {
    if (!self.plusBtn) {
        self.plusBtn = [[SWMXtabbar alloc]initWithCenterImage:[UIImage imageNamed:@"tab_start_live"]highlightedImage:[UIImage imageNamed:@"tab_start_live"]];
