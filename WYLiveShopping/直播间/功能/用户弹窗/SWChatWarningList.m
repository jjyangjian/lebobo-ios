...
@interface SWWarningCell:UITableViewCell
+(instancetype)cellForTableView:(UITableView *)tableView;
@property(nonatomic,strong)UILabel *tipLabel;
@property(nonatomic,strong)UIView *line;

@end
@implementation SWWarningCell

+(instancetype)cellForTableView:(UITableView *)tableView{
    SWWarningCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SWWarningCell"];
    if (!cell) {
        cell = [[SWWarningCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"SWWarningCell"];
...
@interface SWChatWarningList ()<UITableViewDelegate,UITableViewDataSource>
...
@end
@implementation SWChatWarningList
