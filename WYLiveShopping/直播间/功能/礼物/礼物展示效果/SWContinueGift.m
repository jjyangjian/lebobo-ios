...
//    NSString *giftcount = @"1";
    ...
    SWCFGradientLabel *labGiftNum = [[SWCFGradientLabel alloc] init];//礼物数量
...
//        make.top.equalTo(giftBGView).offset(-15);
    ...
    SWCFGradientLabel *giftXL = [[SWCFGradientLabel alloc] init];
...
{
    __weak SWCFGradientLabel *labGiftNum = (SWCFGradientLabel *)[self viewWithTag:tag];
