...
#import "SWBrowserRecordCell.h"
#import "SWUserPopupView.h"
#import "SWChatModel.h"
@interface SWLiveOnlineList()<UITableViewDelegate,UITableViewDataSource,BrowserRecordCellDelegate,SWUserPopupViewDeleagte>{
    int paging;
    NSString *anchorID;
...
@end
@implementation SWLiveOnlineList
...
- (void)requestData{
    ...
    [SWToolClass getQCloudWithUrl:postUrl Suc:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
...
- (void)userToast:(SWChatModel *)model{
    if ([model.userID isEqualToString:[SWConfig getOwnID]]) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    SWBrowserRecordCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SWBrowserRecordCell"];
    cell.vc = self.vc;
    cell.delegate = self;
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"SWBrowserRecordCell" bundle:nil] forCellReuseIdentifier:@"SWBrowserRecordCell"];
