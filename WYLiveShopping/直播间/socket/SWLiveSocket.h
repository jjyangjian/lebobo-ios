...
@protocol SWLiveSocketDelegate <NSObject>
//收到聊天消息
...
@optional
@end
@interface SWLiveSocket : NSObject

@property(nonatomic,weak)id<SWLiveSocketDelegate>delegate;
@property(nonatomic,strong)NSDictionary *roomMap;
//连接socket
-(void)addNodeListen:(NSString *)socketUrl andRoomMessage:(NSDictionary *)roomMap;//添加cosket监听
//断开socket连接
-(void)closeSocket;
-(void)closeRoom;
-(void)userLeaveRoom;
