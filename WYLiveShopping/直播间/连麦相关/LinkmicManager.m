...
static LinkmicManager *_singleton = nil;

@implementation LinkmicManager
...
-(void)livemicCdn {
    ...
    [WYToolClass postNetworkWithUrl:@"livemic/cdn" andParameter:changelive success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
...
-(void)livemicStop {
    ...
    [WYToolClass postNetworkWithUrl:@"livemic/stop" andParameter:changelive success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
...
-(void)livemicSwitch:(int)status {
    ...
    [WYToolClass postNetworkWithUrl:@"livemic/switch" andParameter:changelive success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        [MBProgressHUD showError:msg];
        if (code == 200) {
            [LinkmicManager shareInstance].linkSwitch = status == 1 ? YES:NO;
        }
    } fail:^{
...
-(void)livemicManage:(BOOL)isAgree andUserid:(NSString*)touid handle:(LinkmicHandle)handle{
    ...
    [WYToolClass postNetworkWithUrl:@"livemic/manage" andParameter:changelive success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        [MBProgressHUD showError:msg];
        if (code == 200) {
            if (handle) {
...
-(void)livemicMix:(NSString *)touid {
    ...
    [WYToolClass postNetworkWithUrl:@"livemic/mix" andParameter:changelive success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        [MBProgressHUD showError:msg];
        if (code == 200) {
...
-(void)userApplay:(LinkmicHandle)handle {
    ...
    [WYToolClass postNetworkWithUrl:@"livemic/apply" andParameter:changelive success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        [MBProgressHUD showError:msg];
        if (code == 200) {
            if (handle) {
                handle(Link_Apply,0,@{});
...
-(void)userCancel:(LinkmicHandle)handle {
    ...
    [WYToolClass postNetworkWithUrl:@"livemic/cancle" andParameter:changelive success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        [MBProgressHUD showError:msg];
        if (code == 200) {
            if (handle) {
...
//    };
    ...
    [WYToolClass getQCloudWithUrl:getUrl Suc:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        [MBProgressHUD showError:msg];
        if (code == 200) {
            /**
             返回值：
